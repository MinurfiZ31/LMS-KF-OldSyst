...
class TransaksiController extends Controller
{
    ...
    public function index()
    {
        ...
        'table_buku.judul_buku','table_buku.deskripsi','table_kategori.deskripsi as ketegori','table_buku.thn_terbit',
...
if(Anggota::where('id_anggota', $request->id_anggota)->count() > 0){
    ...
    {
        $pinjam = DB::table('table_transaksi')
        ->join('table_buku','table_buku.id_buku','=table_transaksi.id_buku')
        ...
        'table_buku.id_buku','table_buku.judul_buku','table_buku.deskripsi','table_buku.thn_terbit','table_buku.isbn',
        'table_kategori.deskripsi as ketegori','table_transaksi.tgl_pinjam',
    ...
    public function showBuku($id)
{
    ...
    if(Buku::where('id_buku',$id)->count()>0){
        ...
        'table_buku.thn_terbit','table_buku.isbn','table_kategori.deskripsi as kategori','table_buku.cover_img')
